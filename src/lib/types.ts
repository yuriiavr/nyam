...
export interface ShoppingItem {
   ...
   *
   * У коморі такого поля немає й не треба: там ключ рядка — пара «людина +
   * продукт», тож чужий запис фізично не переписати. Тут ключ власний, і без
   * цього поля будь-яка галочка переписувала б власника на того, хто її
   * поставив, — а разом із сімʼєю розійшлись би й списки: те, що додав ти,
   * пішло б за іншою людиною.
   */
  ownerId?: string;
}
