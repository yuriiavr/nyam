...
export const INGREDIENTS: IngredientDef[] = [
  ...
  D("izyum", "Родзинки", "🍇", "fruit", ["родзинки", "изюм", "raisins"], [299, 3.1, 0.5, 79]),
  ...
  /* ── Мʼясо ───────────────────────────────────────────────────────────── */
  D("kurka", "Куряче філе", "🍗", "meat", ["курка", "куряче філе", "курица", "chicken"], [165, 31, 3.6, 0]),
  ...
  D("bekon", "Бекон", "🥓", "meat", ["бекон", "панчета", "гуанчале", "bacon"], [541, 37, 42, 1.4]),
  D("vetchyna", "Шинка", "🍖", "meat", ["шинка", "ветчина", "ham"], [145, 18, 8, 1.5]),
  D("kovbasa", "Ковбаса", "🌭", "meat", ["ковбаса", "сосиски", "sausage"], [301, 12, 27, 3]),
  D("salo", "Сало", "🥓", "meat", ["сало", "шпик", "lard"], [797, 2.4, 89, 0]),
  D("smalets", "Смалець", "🫙", "meat", ["смалець", "смалец", "лярд"], [900, 0, 100, 0]),

  /* ── Риба та морепродукти ────────────────────────────────────────────── */
  D("losos", "Лосось", "🐟", "fish", ["лосось", "сьомга", "salmon"], [208, 20, 13, 0]),
  D("forel", "Форель", "🐟", "fish", ["форель", "trout"], [148, 21, 7, 0]),
  D("bila_ryba", "Біла риба", "🐠", "fish", ["хек", "минтай", "тріска", "cod"], [82, 18, 0.7, 0]),
  ...
  D("smetana", "Сметана", "🥣", "dairy", ["сметана", "sour cream"], [193, 2.8, 20, 3.4]),
  D("vershky", "Вершки", "🍶", "dairy", ["вершки", "сливки", "cream"], [292, 2.5, 30, 3.2], { unit: "ml" }),
  D("syr", "Твердий сир", "🧀", "dairy", ["твердий сир", "гауда", "чедер", "cheese"], [380, 25, 30, 2]),
  D("parmezan", "Пармезан", "🧀", "dairy", ["пармезан", "пекорино", "parmesan"], [431, 38, 29, 4.1]),
  ...
  /* ── Крупи, паста, бобові ────────────────────────────────────────────── */
  D("rys", "Рис", "🍚", "grain", ["рис", "rice"], [360, 7, 0.7, 79]),
  D("ris_burui", "Бурий рис", "🍚", "grain", ["бурий рис", "brown rice"], [370, 7.9, 2.9, 77]),
  D("grechka", "Гречка", "🌾", "grain", ["гречка", "buckwheat"], [343, 13, 3.4, 72]),
  D("makarony", "Паста", "🍝", "grain", ["макарони", "спагеті", "паста", "pasta", "spaghetti"], [371, 13, 1.5, 75]),
  D("lokshyna", "Локшина", "🍜", "grain", ["локшина", "удон", "рамен", "noodles"], [348, 12, 1.4, 71]),
  D("boroshno", "Борошно", "🌾", "grain", ["борошно", "мука", "flour"], [364, 10, 1, 76], { staple: true }),
  D("kukurudziane_boroshno", "Кукурудзяне борошно", "🌽", "grain", ["кукурудзяне борошно", "cornmeal"], [361, 7, 3.9, 76]),
  D("vivsyanka", "Вівсянка", "🥣", "grain", ["вівсянка", "овсянка", "oats"], [389, 17, 7, 66]),
  D("bulgur", "Кус-кус / булгур", "🍛", "grain", ["кускус", "булгур", "couscous"], [342, 12, 1.3, 76]),
  D("kinoa", "Кіноа", "🌾", "grain", ["кіноа", "квіноа", "quinoa"], [368, 14, 6, 64]),
  D("perlivka", "Перлова крупа", "🌾", "grain", ["перлівка", "перловка", "barley"], [352, 9.9, 1.2, 77]),
  D("pshono", "Пшоно", "🌾", "grain", ["пшоно", "пшено", "millet"], [378, 11, 4.2, 73]),
  D("manka", "Манна крупа", "🌾", "grain", ["манка", "манна крупа", "semolina"], [333, 10, 1, 73]),
  D("kvasolya", "Квасоля", "🫘", "grain", ["квасоля", "фасоль", "beans"], [333, 24, 0.8, 60]),
  D("nut", "Нут", "🟤", "grain", ["нут", "chickpeas"], [364, 19, 6, 61]),
  D("sochevytsya", "Сочевиця", "🟠", "grain", ["сочевиця", "чечевица", "lentils"], [353, 25, 1.1, 60]),
  D("horokh", "Горох", "🟢", "grain", ["горох", "peas dried"], [348, 23, 1.2, 60]),
  D("soya", "Соя", "🫘", "grain", ["соя", "soybean"], [446, 36, 20, 30]),
  D("krokhmal", "Крохмаль", "🤍", "grain", ["крохмаль", "крахмал", "starch"], [381, 0.1, 0.1, 91], { staple: true }),
  D("panirovka", "Панірувальні сухарі", "🍞", "grain", ["панірувальні сухарі", "паніровка", "breadcrumbs"], [395, 13, 5, 72]),
  D("otrubi", "Висівки", "🌾", "grain", ["висівки", "отруби", "bran"], [216, 16, 4.3, 65]),

  /* ── Спеції та сипке ─────────────────────────────────────────────────── */
  D("sil", "Сіль", "🧂", "spice", ["сіль", "salt"], [0, 0, 0, 0], { staple: true }),
  ...
  D("tsukor", "Цукор", "🍬", "spice", ["цукор", "сахар", "sugar"], [387, 0, 0, 100], { staple: true }),
  D("tsukor_korychnevyi", "Коричневий цукор", "🟤", "spice", ["коричневий цукор", "brown sugar"], [380, 0, 0, 98]),
  D("tsukrova_pudra", "Цукрова пудра", "🤍", "spice", ["цукрова пудра", "сахарная пудра"], [389, 0, 0, 100]),
  D("vanilnyi_tsukor", "Ванільний цукор", "🍚", "spice", ["ванільний цукор", "ванильный сахар", "vanilla sugar"], [389, 0, 0, 99]),
  D("kakao", "Какао", "🍫", "spice", ["какао", "cocoa"], [228, 20, 14, 58]),
  D("vanil", "Ваніль", "🌼", "spice", ["ваніль", "ванільний екстракт", "vanilla"], [288, 0.1, 0.1, 13], { staple: true }),
  D("rozpushuvach", "Розпушувач / сода", "🧪", "spice", ["розпушувач", "сода", "baking powder"], [53, 0, 0, 28], { staple: true }),
  D("drizhdzhi", "Дріжджі", "🫧", "spice", ["дріжджі", "yeast"], [105, 12, 2, 13]),
  D("zhelatyn", "Желатин", "🧊", "spice", ["желатин", "gelatin"], [355, 87, 0.1, 0]),

  /* ── Соуси та олії ───────────────────────────────────────────────────── */
  D("oliya", "Олія", "🫗", "sauce", ["олія", "соняшникова олія", "oil"], [899, 0, 100, 0], { staple: true, unit: "ml" }),
  D("olyvkova", "Оливкова олія", "🫒", "sauce", ["оливкова олія", "olive oil"], [884, 0, 100, 0], { staple: true, unit: "ml" }),
  D("kunzhutna_oliya", "Кунжутна олія", "🫗", "sauce", ["кунжутна олія", "sesame oil"], [884, 0, 100, 0], { unit: "ml" }),
  D("kokosova_oliya", "Кокосова олія", "🥥", "sauce", ["кокосова олія", "coconut oil"], [862, 0, 100, 0]),
  D("soyevyi", "Соєвий соус", "🍶", "sauce", ["соєвий соус", "soy sauce"], [53, 8, 0.6, 4.9], { unit: "ml" }),
  ...
  D("tomatna_pasta", "Томатна паста", "🥫", "sauce", ["томатна паста", "tomato paste"], [82, 4.3, 0.5, 19]),
  D("pomidory_konserv", "Томати в соку", "🥫", "sauce", ["консервовані томати", "пасата", "passata"], [32, 1.6, 0.3, 7]),
  D("ketchup", "Кетчуп", "🍅", "sauce", ["кетчуп", "ketchup"], [112, 1.3, 0.2, 26]),
  D("maionez", "Майонез", "🧴", "sauce", ["майонез", "mayo"], [680, 1, 75, 2.6]),
  D("girchytsya", "Гірчиця", "🌭", "sauce", ["гірчиця", "mustard"], [66, 4.4, 3.4, 5.8]),
  ...
  D("med", "Мед", "🍯", "sauce", ["мед", "honey"], [304, 0.3, 0, 82]),
  D("dzhem", "Джем", "🍓", "sauce", ["джем", "варення", "jam"], [278, 0.4, 0.1, 69]),
  D("kokos_moloko", "Кокосове молоко", "🥥", "sauce", ["кокосове молоко", "coconut milk"], [230, 2.3, 24, 6], { unit: "ml" }),
  D("tahini", "Тахіні", "🥜", "sauce", ["тахіні", "кунжутна паста", "tahini"], [595, 17, 54, 21]),
  D("arahisova_pasta", "Арахісова паста", "🥜", "sauce", ["арахісова паста", "peanut butter"], [588, 25, 50, 20]),
  ...
  /* ── Хліб та випічка ─────────────────────────────────────────────────── */
  D("khlib", "Хліб", "🍞", "bakery", ["хліб", "багет", "bread"], [265, 9, 3.2, 49]),
  D("baton", "Батон", "🥖", "bakery", ["батон", "loaf"], [264, 8, 3, 51]),
  D("khlib_zhytniy", "Житній хліб", "🍞", "bakery", ["житній хліб", "чорний хліб", "rye bread"], [259, 8.5, 3.3, 48]),
  ...
  D("pechyvo", "Печиво", "🍪", "bakery", ["печиво", "cookies"], [417, 6, 17, 62]),
  D("savoyardi", "Печиво савоярді", "🍪", "bakery", ["савоярді", "ladyfingers"], [393, 8, 6, 76]),

  /* ── Інше ────────────────────────────────────────────────────────────── */
  D("gorikhy", "Горіхи", "🥜", "other", ["горіхи", "nuts"], [654, 15, 65, 14]),
  D("voloski", "Волоські горіхи", "🌰", "other", ["волоські горіхи", "walnuts"], [654, 15, 65, 14]),
  D("mygdal", "Мигдаль", "🌰", "other", ["мигдаль", "миндаль", "almonds"], [579, 21, 50, 22]),
  D("funduk", "Фундук", "🌰", "other", ["фундук", "hazelnut"], [628, 15, 61, 17]),
  D("keshyu", "Кешʼю", "🌰", "other", ["кешʼю", "кешью", "cashew"], [553, 18, 44, 30]),
  D("fistashky", "Фісташки", "🌰", "other", ["фісташки", "pistachio"], [560, 20, 45, 28]),
  D("arahis", "Арахіс", "🥜", "other", ["арахіс", "peanut"], [567, 26, 49, 16]),
  D("kunzhut", "Кунжут", "⚪", "other", ["кунжут", "sesame"], [573, 18, 50, 23]),
  D("nasinnya_soniashnyka", "Соняшникове насіння", "🌻", "other", ["соняшникове насіння", "семечки"], [584, 21, 51, 20]),
  D("garbuzove_nasinnya", "Гарбузове насіння", "🎃", "other", ["гарбузове насіння", "pumpkin seeds"], [559, 30, 49, 11]),
  D("chia", "Насіння чіа", "⚫", "other", ["чіа", "chia"], [486, 17, 31, 42]),
  D("lnyane", "Насіння льону", "🟤", "other", ["льон", "лляне насіння", "flax"], [534, 18, 42, 29]),
  D("kokosova_struzhka", "Кокосова стружка", "🥥", "other", ["кокосова стружка", "coconut flakes"], [660, 7, 65, 24]),
  D("shokolad", "Шоколад", "🍫", "other", ["шоколад", "chocolate"], [546, 4.9, 31, 61]),
