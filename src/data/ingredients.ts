...
export const INGREDIENTS: IngredientDef[] = [
  ...
  D("chasnyk", "Часник", "🧄", "veg", ["часник", "чеснок", "garlic", "часниковий"], [149, 6.4, 0.5, 33], { staple: true, perPiece: 3 }),
  ...
  /* ── Молочне та яйця ─────────────────────────────────────────────────── */
  D("yajtsya", "Яйця", "🥚", "dairy", ["яйця", "яйце", "яйца", "egg", "яйце куряче", "курячі яйця"], [155, 13, 11, 1.1], { staple: true, perPiece: 60 }),
  ...
  D("maslo", "Вершкове масло", "🧈", "dairy", ["вершкове масло", "butter", "масло", "солодковершкове масло", "селянське масло"], [717, 0.9, 81, 0.1], { staple: true }),
