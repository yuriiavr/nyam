...
// Зубчик — власна міра: у рецептах пишуть саме так, і три грами на зубчик
// точніші, ніж «штука часнику», під якою можна розуміти й цілу головку.
check("«2 зубчики»", units.parseQty("2 зубчики"), { amount: 2, unit: "clove" });

// Решта побутових мір зводиться до штук — вагу однієї знає довідник.
