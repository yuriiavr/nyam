...
-- Для запобіжника нижче: скільки будильників у людини. І для сторінки
-- готування, що шукає свої «загублені» будильники цього рецепта.
 ...
 * - Не більше 20 будильників на людину. На одній сторінці готування таймер
 *   один; решта запасу — на кілька пристроїв і на скасування, що не дійшли.
